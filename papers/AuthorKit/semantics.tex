...
\todo{Tohle je lež, nechtělo se mi to dobíhat do konce}We had similar results with the experiments with the context of distance two.
...
%Here we faced a problem of choosing between precison and recall.
