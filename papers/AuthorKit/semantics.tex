...
% - that is, 
%whether we can try to add endings and beginnings of the words on the left and on the right.
...
%We have thought that with combined features from context and morphology, the approaches would complement 
...
%this didn't turn out to be true - the results are very slightly worse, than with morphology alone, 
further underlining the fact that the morphology of the words, 
%at least in our case and with our technique, 
